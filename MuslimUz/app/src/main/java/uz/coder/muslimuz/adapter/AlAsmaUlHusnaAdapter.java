...
public class AlAsmaUlHusnaAdapter extends  RecyclerView.Adapter<AlAsmaUlHusnaAdapter.VH>{
    ...
    public AlAsmaUlHusnaAdapter(List<AlAsmaAlHusnaModel> alAsmaAlHusnaModelList,onItemClik onItemClik) {
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        holder.binding.textView.setSelected(true);
        holder.binding.textView.setText(alAsmaAlHusnaModelList.get(position).getMessege());
        AlAsmaAlHusnaModel alAsmaAlHusnaModel = alAsmaAlHusnaModelList.get(position);
        holder.itemView.setOnClickListener(v -> onItemClik.onClik(alAsmaAlHusnaModel,position));
    }
    ...
    public interface  onItemClik{
        void onClik(AlAsmaAlHusnaModel alAsmaAlHusnaModel , int pozition);
    }
